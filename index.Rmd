...
\bar{\ell}_{\alpha}^{-}(I),
 \mathrm{\,\,for\,\,all\,\,}I  \Big) \geq 1- \alpha.$$
For finding $\bar{\ell}_{\alpha}^+(I)$ and $\bar{\ell}_{\alpha}^-(I)$ we use the *partitioning principle* to the $2^n$ orthants defined by $\theta_i \in \{(-\infty,0],(0,\infty)\}, i=1,\ldots, n$. Heller & Solari (2023) showed that the bounds obtained through the partitioning principle with *adaptive tests* uniformly improves upon the DCT bounds:
